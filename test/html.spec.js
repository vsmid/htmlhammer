...
o.spec("HTML", () => {
    ...
    o.spec("Exports", () => {
        ...
        o.spec("Main root non deprecated HTML tag creating functions", () => {
            o("html", () => { o(html.html().nodeName).equals("html"); });
        });

        o.spec("Document metadata non deprecated HTML tag creating functions", () => {
            o("base", () => { o(html.base().nodeName).equals("base"); });
            o("head", () => { o(html.head().nodeName).equals("head"); });
            o("link", () => { o(html.link().nodeName).equals("link"); });
            o("meta", () => { o(html.meta().nodeName).equals("meta"); });
            o("style", () => { o(html.style().nodeName).equals("style"); });
            o("title", () => { o(html.title().nodeName).equals("title"); });
        });

        o.spec("Sectioning root non deprecated HTML tag creating functions", () => {
            o("body", () => { o(html.body().nodeName).equals("body"); });
        });

        o.spec("Content sectioning non deprecated HTML tag creating functions", () => {
            o("address", () => { o(html.address().nodeName).equals("address"); });
            o("article", () => { o(html.article().nodeName).equals("article"); });
            o("aside", () => { o(html.aside().nodeName).equals("aside"); });
            o("footer", () => { o(html.footer().nodeName).equals("footer"); });
            o("header", () => { o(html.header().nodeName).equals("header"); });
            o("h1", () => { o(html.h1().nodeName).equals("h1"); });
            o("h2", () => { o(html.h2().nodeName).equals("h2"); });
            o("h3", () => { o(html.h3().nodeName).equals("h3"); });
            o("h4", () => { o(html.h4().nodeName).equals("h4"); });
            o("h5", () => { o(html.h5().nodeName).equals("h5"); });
            o("h6", () => { o(html.h6().nodeName).equals("h6"); });
            o("hggroup", () => { o(html.hggroup().nodeName).equals("hggroup"); });
            o("main", () => { o(html.main().nodeName).equals("main"); });
            o("nav", () => { o(html.nav().nodeName).equals("nav"); });
            o("section", () => { o(html.section().nodeName).equals("section"); });
        });

        o.spec("Text content non deprecated HTML tag creating functions", () => {
            o("blockquote", () => { o(html.blockquote().nodeName).equals("blockquote"); });
            o("dd", () => { o(html.dd().nodeName).equals("dd"); });
            o("div", () => { o(html.div().nodeName).equals("div"); });
            o("dl", () => { o(html.dl().nodeName).equals("dl"); });
            o("dt", () => { o(html.dt().nodeName).equals("dt"); });
            o("figcaption", () => { o(html.figcaption().nodeName).equals("figcaption"); });
            o("figure", () => { o(html.figure().nodeName).equals("figure"); });
            o("hr", () => { o(html.hr().nodeName).equals("hr"); });
            o("li", () => { o(html.li().nodeName).equals("li"); });
            o("ol", () => { o(html.ol().nodeName).equals("ol"); });
            o("p", () => { o(html.p().nodeName).equals("p"); });
            o("pre", () => { o(html.pre().nodeName).equals("pre"); });
            o("ul", () => { o(html.ul().nodeName).equals("ul"); });
        });

        o.spec("Inline text semantics non deprecated HTML tag creating functions", () => {
            o("a", () => { o(html.a().nodeName).equals("a"); });
            o("abbr", () => { o(html.abbr().nodeName).equals("abbr"); });
            o("b", () => { o(html.b().nodeName).equals("b"); });
            o("bdi", () => { o(html.bdi().nodeName).equals("bdi"); });
            o("bdo", () => { o(html.bdo().nodeName).equals("bdo"); });
            o("br", () => { o(html.br().nodeName).equals("br"); });
            o("cite", () => { o(html.cite().nodeName).equals("cite"); });
            o("code", () => { o(html.code().nodeName).equals("code"); });
            o("data", () => { o(html.data().nodeName).equals("data"); });
            o("dfn", () => { o(html.dfn().nodeName).equals("dfn"); });
            o("em", () => { o(html.em().nodeName).equals("em"); });
            o("i", () => { o(html.i().nodeName).equals("i"); });
            o("kbd", () => { o(html.kbd().nodeName).equals("kbd"); });
            o("mark", () => { o(html.mark().nodeName).equals("mark"); });
            o("q", () => { o(html.q().nodeName).equals("q"); });
            o("rb", () => { o(html.rb().nodeName).equals("rb"); });
            o("rp", () => { o(html.rp().nodeName).equals("rp"); });
            o("rt", () => { o(html.rt().nodeName).equals("rt"); });
            o("rtc", () => { o(html.rtc().nodeName).equals("rtc"); });
            o("ruby", () => { o(html.ruby().nodeName).equals("ruby"); });
            o("s", () => { o(html.s().nodeName).equals("s"); });
            o("samp", () => { o(html.samp().nodeName).equals("samp"); });
            o("small", () => { o(html.small().nodeName).equals("small"); });
            o("span", () => { o(html.span().nodeName).equals("span"); });
            o("strong", () => { o(html.strong().nodeName).equals("strong"); });
            o("sub", () => { o(html.sub().nodeName).equals("sub"); });
            o("sup", () => { o(html.sup().nodeName).equals("sup"); });
            o("time", () => { o(html.time().nodeName).equals("time"); });
            o("u", () => { o(html.u().nodeName).equals("u"); });
            o("variable", () => { o(html.variable().nodeName).equals("variable"); });
            o("wbr", () => { o(html.wbr().nodeName).equals("wbr"); });
        });

        o.spec("Image and multimedia non deprecated HTML tag creating functions", () => {
            o("area", () => { o(html.area().nodeName).equals("area"); });
            o("audio", () => { o(html.audio().nodeName).equals("audio"); });
            o("img", () => { o(html.img().nodeName).equals("img"); });
            o("map", () => { o(html.map().nodeName).equals("map"); });
            o("track", () => { o(html.track().nodeName).equals("track"); });
            o("video", () => { o(html.video().nodeName).equals("video"); });
        });

        o.spec("Embedded content non deprecated HTML tag creating functions", () => {
            o("embed", () => { o(html.embed().nodeName).equals("embed"); });
            o("iframe", () => { o(html.iframe().nodeName).equals("iframe"); });
            o("object", () => { o(html.object().nodeName).equals("object"); });
            o("param", () => { o(html.param().nodeName).equals("param"); });
            o("picture", () => { o(html.picture().nodeName).equals("picture"); });
            o("source", () => { o(html.source().nodeName).equals("source"); });
        });

        o.spec("Scripting non deprecated HTML tag creating functions", () => {
            o("canvas", () => { o(html.canvas().nodeName).equals("canvas"); });
            o("noscript", () => { o(html.noscript().nodeName).equals("noscript"); });
            o("script", () => { o(html.script().nodeName).equals("script"); });
        });

        o.spec("Demarcating edits non deprecated HTML tag creating functions", () => {
            o("del", () => { o(html.del().nodeName).equals("del"); });
            o("ins", () => { o(html.ins().nodeName).equals("ins"); });
        });

        o.spec("Table content non deprecated HTML tag creating functions", () => {
            o("caption", () => { o(html.caption().nodeName).equals("caption"); });
            o("col", () => { o(html.col().nodeName).equals("col"); });
            o("colgroup", () => { o(html.colgroup().nodeName).equals("colgroup"); });
            o("table", () => { o(html.table().nodeName).equals("table"); });
            o("tbody", () => { o(html.tbody().nodeName).equals("tbody"); });
            o("td", () => { o(html.td().nodeName).equals("td"); });
            o("tfoot", () => { o(html.tfoot().nodeName).equals("tfoot"); });
            o("th", () => { o(html.th().nodeName).equals("th"); });
            o("thead", () => { o(html.thead().nodeName).equals("thead"); });
            o("tr", () => { o(html.tr().nodeName).equals("tr"); });
        });

        o.spec("Forms non deprecated HTML tag creating functions", () => {
            o("button", () => { o(html.button().nodeName).equals("button"); });
            o("datalist", () => { o(html.datalist().nodeName).equals("datalist"); });
            o("fieldset", () => { o(html.fieldset().nodeName).equals("fieldset"); });
            o("form", () => { o(html.form().nodeName).equals("form"); });
            o("input", () => { o(html.input().nodeName).equals("input"); });
            o("label", () => { o(html.label().nodeName).equals("label"); });
            o("legend", () => { o(html.legend().nodeName).equals("legend"); });
            o("meter", () => { o(html.meter().nodeName).equals("meter"); });
            o("oprgroup", () => { o(html.oprgroup().nodeName).equals("oprgroup"); });
            o("option", () => { o(html.option().nodeName).equals("option"); });
            o("output", () => { o(html.output().nodeName).equals("output"); });
            o("progress", () => { o(html.progress().nodeName).equals("progress"); });
            o("select", () => { o(html.select().nodeName).equals("select"); });
            o("textarea", () => { o(html.textarea().nodeName).equals("textarea"); });
        });

        o.spec("Interactive elements non deprecated HTML tag creating functions", () => {
            o("details", () => { o(html.details().nodeName).equals("details"); });
            o("dialog", () => { o(html.dialog().nodeName).equals("dialog"); });
            o("menu", () => { o(html.menu().nodeName).equals("menu"); });
            o("summary", () => { o(html.summary().nodeName).equals("summary"); });
        });

        o.spec("Web Components non deprecated HTML tag creating functions", () => {
            o("slot", () => { o(html.slot().nodeName).equals("slot"); });
            o("template", () => { o(html.template().nodeName).equals("template"); });
        });
    });
    ...
    o.spec("#attachAttribute", () => {
        ...
        o("Should handle style attribute as JSON", () => {
            attachAttribute("style", { color: "red", fontSize: "10px" }, element);

            o(element.getAttribute("style")).equals("color:red;font-size:10px;");
        });

        o("Attribute names starting with 'on' and are defined on element are treated as events", () => {
            let counter = 0;
    ...
    o.spec("#appendChild", () => {
        ...
        o("Should append all other types not tested above as text node by calling #toString() method", () => {
            let element = document.createElement("div");
            class Person {
                toString() {
                    return "Lena";
    ...
    o.spec("#define", () => {
        ...
        o("Should create single HTML element based on HTML element definition function", () => {
        ...
        o("Should create multiple HTML element based on HTML element definition function -> $for", () => {
            let divFn = define("div");
        ...
        o("Should create single HTML element based on HTML element definition function -> $for & $if", () => {
            let divFn = define("div");
            let elements = divFn({ $for: [1, 2], $if: val => val > 1 }, val => val);
        ...
        o("Should create single HTML element based on HTML element definition function -> $for & $if & $ref", () => {
            let divFn = define("div");
            let items = [{ v: 1 }, { v: 2 }];
            let elements = divFn({ $for: items, $if: i => i.v > 1, $ref: setRef }, i => i.v);
