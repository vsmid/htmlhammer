...
o.spec('HTML', () => {
  o.spec('Exports', () => {
    ...
    o.spec(
      'Main root non deprecated HTML tag creating functions',
      () => {
        o('html', () => {
    ...
    o.spec(
      'Scripting non deprecated HTML tag creating functions',
      () => {
        o('canvas', () => {
    ...
    o.spec(
      'Forms non deprecated HTML tag creating functions',
      () => {
        o('button', () => {
  ...
  o.spec('#attachAttribute', () => {
    const attachAttribute =
      require('../cjs/html').attachAttribute;
    const AttributeHandler =
      require('../cjs/html').AttributeHandler;
    ...
    o(
      'Should not attach reserved attributes from AttributeHandler',
      () => {
    ...
    o(
      'Attribute names describing events are case sensitive',
      () => {
        let counter = 0;
  ...
  o.spec('AttributeHandler', () => {
    const AttributeHandler =
      require('../cjs/html.js').AttributeHandler;
    const Blueprint = require('../cjs/html.js').Blueprint;
    ...
    o.spec('$ref', () => {
      ...
      o(
        'Should reference given element without using setRef',
        () => {
          let element = document.createElement('div');
          let ob = {};
    ...
    o.spec('$apply', () => {
      o(
        'Should apply custom function to the given element',
        () => {
  ...
  o.spec('#createElement', () => {
    const createElement =
      require('../cjs/html.js').createElement;
    const Blueprint = require('../cjs/html.js').Blueprint;
  ...
  o.spec('#elementOptions', () => {
    const elementOptions =
      require('../cjs/html.js').elementOptions;
